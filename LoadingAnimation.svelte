...
<div class="loadingAni flex h-full items-center justify-center w-full" style="--int-loader-height: {height}px">
  <div
  ...
  <span class="text-primary-base dark:text-dm-primary-base"><svg class="fill-current" width="40" height="66"
                                                                 viewBox="0 0 24 30"
                                                                 role="img" aria-hidden="true"><path
      class="fill-current"
      d="M20 29.4V13H6.3V5.4h7.2V10H20V3.4C20 1.5 18.4 0 16.5 0h-13C1.6 0 0 1.6 0 3.5v15h13.5v9H6.3v-6.1H0v8C0 31.3 1.6 33 3.5 33h13c1.9-.2 3.5-1.7 3.5-3.6z"></path></svg>
</span>
</div>
