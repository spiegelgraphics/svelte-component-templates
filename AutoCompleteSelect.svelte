      ...
      >
        ...
        <div slot="chevron-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <circle cx="10" cy="11" r="5.35" stroke="black" stroke-width="1.3"/>
            <path d="M14 15L18.5 19.5" stroke="black" stroke-width="1.3" stroke-linecap="round"/>
          </svg>
        </div>
